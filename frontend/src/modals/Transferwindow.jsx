...
export function Transferwindow({closemodal, firstName, lastName, to}) {
    ...
    return (
        <div className="absolute text-white bg-black bg-opacity-0  w-screen h-screen flex flex-col items-center" onClick={closemodal}>
            <div className="bg-app-black w-1/4 rounded-md p-8 text-black border-2 shadow-xl bg-white" onClick={(e) => {e.stopPropagation();}}>
